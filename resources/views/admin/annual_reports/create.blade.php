...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title text-center">Add Annual Report</h3>
                    <p class="text-muted text-center"> Add annual report on form below</p>
                    ...
                    <div class="card">
                        <div class="card- content">
                            ...
                            <form enctype="multipart/form-data" method="POST"
                                  action="/admin/annual_reports/store"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 mb-4">
                                        <div class="col-md-12 border-bottom p-0">
                                            <label class="p-0">Report File - PDF </label>
                                            <input required accept="application/pdf" name="report_url" type="file"
                                                   placeholder=""
                                                   class="form-control p-0 border-0">
                                        </div>
                                    </div>
