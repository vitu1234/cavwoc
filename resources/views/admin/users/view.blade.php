                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 mb-4">
                                        <div class="col-md-12 border-bottom p-0">
                                            ...
                                            <input value="{{$user->first_name}}" required name="first_name" type="text"
                                    ...
                                    <div class="form-group col-md-6 mb-4">
                                        <div class="col-md-12 border-bottom p-0">
                                            ...
                                            <input value="{{$user->last_name}}" required name="last_name" type="text"
                                                   placeholder="Doe"
                                                   class="form-control p-0 border-0">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 mb-4">
                                        <div class="col-md-12 border-bottom p-0">
                                            ...
                                            <input value="{{$user->email}}" required name="email" type="email"
                                    ...
                                    <div class="form-group col-md-6 mb-4">
                                        <div class="col-md-12 border-bottom p-0">
                                            ...
                                            <input value="{{$user->phone}}" required name="phone" type="text"
