...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title text-center">Add Vacancy</h3>
                    <p class="text-muted text-center"> Add vacancy on form below</p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form enctype="multipart/form-data" method="POST" action="/admin/vacancies/store"
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 mb-4">
                                        <div class="col-md-12 border-bottom p-0">
                                            ...
                                            <input required name="title" type="text" placeholder="Ex: Software Engineer"
                                    ...
                                    <div class="form-group col-md-6 mb-4">
                                        <div class="col-md-12 border-bottom p-0">
                                            ...
                                            <input min="{{date('Y-m-d')}}" required name="dateline" type="date"
