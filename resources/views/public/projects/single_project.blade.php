                ...
                <div class="row">
                    <div class="col-sm-3 col-md-3">
                        ...
                        <div class="widget widget-archive">
                            ...
                            <ul style="">
                                @foreach($related_projects as $project_related)
                                    <li class="list">
                                        <a class="text-dark"
                                           href="/projects/{{$project_related->id}}">{{ \Illuminate\Support\Str::of($project_related->project_name)->words(5,'...')}}
                                            - {{ucfirst($project_related->project_type)}}
                                            -
                                            <span class="text-muted">{{ $project_related->project_period}}
                                            </span>
                                        </a>
                                    </li>
                                @endforeach
                    ...
                    <div class="col-sm-9 col-md-9">
                        @if(!empty($project))
                            <div class="single-projects">
                                ...
                                <div class="meta">
                                    <div class="meta-date">
                                        <p class="">{{ucfirst($project->project_type)}} Project
                                            : {{$project->project_period}}
                                        </p>
                                    </div>

                                    <div class="meta-author "> Funded by: <span>{{$project->project_donor}}</span></div>
                        ...
                        @else
                            <p class="text-danger text-center alert alert-danger m-5" style="width: 100%;">Requested
                                project not found, please check <a href="/projects">HERE</a></p>
                        @endif
                    </div>
