    ...
    <div class="section">
        <div class="content-wrap">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <h2 class="color-secondary"><span class="color-primary">{{$project->project_name}}</span></h2>
                    </div>

                    <div class="col-sm-6 col-md-6">
                        <p>{{ucfirst($project->project_type)}} Project : {{$project->project_period}}</p>
                        ...
                        @if(!empty($project->project_file))
                            <div class="rs-box-download">
                                ...
                                <div class="body">
                                    <a target="_blank" href="<?=url('storage/projects/' . $project->project_file) ?>">
