                                                    ...
                                                    <div class="body-content">
                                                        <div style="height: 80px !important; margin-top: 5px;">
                                                            <p style="max-height: 50px" class="title"><a
                                                                    href="/news/{{$article->id}}">{{ \Illuminate\Support\Str::of($article->title)->words(8,'...')}}</a>
                                                            </p>
                                                            <div
                                                                class="text text-justify text-dark">{{ \Illuminate\Support\Str::of( $article->body)->words(12,'...')}}
                                                            </div>
                                                        </div>
                                                        <div class="spacer-30"></div>
                                                        <a href="/news/{{$article->id}}" class="btn btn-primary">READ
                                                            MORE</a>
                                                    </div>
                                                </div>
                                            </div>
